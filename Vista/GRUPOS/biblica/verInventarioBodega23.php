...
$sql="select * from inventarioescbiblica LIMIT 15";	  
$inventarioBodega = $objConexion->query($sql);
?><head>
<meta charset="utf-8">
<title>Ver_Inventario_Escbiblica</title>
...
<br>
<br>
<h2>INVENTARIO ACTUAL EN BODEGA ESCUELA BIBLICA</h2>
...
?>
	<tr>
		...
		<td>
			<a href="index2.php?pag=ingresoInventario6&idElemento=<?php echo $material->idElemento?>" title="SELECCIONAR">
