...
<form id="form1" name="form1" method="post" action="../Controlador/validarEliminarInventario1.php">
<head>
<meta charset="UTF-8">
<title>Eliminar_Inventario_Alabanza</title>
...
<br>
<br>
<h2>ELIMINAR ELEMENTOS DEL INVENTARIO DE LA BODEGA ALABANZA</h2>

          <tbody>
          <tr>
            <h4> <td>INGRESE EL CODIGO DEL PRODUCTO A ELIMINAR DEL INVENTARIO:</td></h4> 
...
<?php
if ($msj==1)
	echo '<p align="center" >SE HA ELIMINADO UN ELEMENTO CORRECTAMENTE';
if ($msj==2)
	echo '<p align="center">PROBLEMAS EN EL BORRADO DEL ELEMENTO, FAVOR REVISE E INTENTE DE NUEVO';
?>
