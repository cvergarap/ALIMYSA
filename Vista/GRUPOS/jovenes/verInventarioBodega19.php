...
$sql="select * from inventariojovenes LIMIT 15";	  
$inventarioBodega = $objConexion->query($sql);
?><head>
<meta charset="utf-8">
<title>Ver_Inventario_Jovenes</title>
...
<br>
<br>
<h2>INVENTARIO ACTUAL EN BODEGA JOVENES</h2>
...
?>
	<tr>
		...
		<td>
			<a href="index2.php?pag=ingresoInventario4&idElemento=<?php echo $material->idElemento?>" title="SELECCIONAR">
