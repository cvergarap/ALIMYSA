...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventariologistica where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario8.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_logistica</title>
...
<li> <a href="navegacion6.php"><h3>ATRAS</h3></a>
</li>
</ul>
</div>
</nav>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO DE LA BODEGA LOGISTICA GENERAL</h2>

          <tbody>
          <tr>
            <h4> <td>NOMBRE DEL ELEMENTO A INCREMENTAR EN EL INVENTARIO:</td></h4> 
...
<?php
if ($msj==1)
	echo '<p align="center" >SE HA INGRESADO CORRECTAMENTE';
if ($msj==2)
