...
$sql="select * from inventariodamas LIMIT 15";	  
$inventarioBodega = $objConexion->query($sql);
?><head>
<meta charset="utf-8">
<title>Ver_Inventario_Damas</title>
...
<br>
<br>
<h2>INVENTARIO ACTUAL EN BODEGA DAMAS</h2>
...
?>
	<tr>
		...
		<td>
			<a href="index2.php?pag=ingresoInventario7&idElemento=<?php echo $material->idElemento?>" title="SELECCIONAR">
