...
$sql="select * from inventarioinfantil LIMIT 15";	  
$inventarioBodega = $objConexion->query($sql);
?><head>
<meta charset="utf-8">
<title>Ver_Inventario_Infantil</title>
...
<br>
<br>
<h2>INVENTARIO ACTUAL EN BODEGA INFANTIL</h2>
...
?>
	<tr>
		...
		<td>
			<a href="index2.php?pag=ingresoInventario5&idElemento=<?php echo $material->idElemento?>" title="SELECCIONAR">
