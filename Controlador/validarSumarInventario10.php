...
$sql="UPDATE inventariodistri  SET  cantElemento = " . $varDiferencia . " WHERE idElemento = " .$idElemento;
...
if ($resultado)
	header ("location:../Vista/index2.php?pag=ingresoInventario10&msj=1");
else
	header ("location:../Vista/index2.php?pag=ingresoInventario10&msj=2");
?>
