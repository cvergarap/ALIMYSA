...
//datos del producto
$sql="Insert nombElemento, cantElemento, mediElemento from inventariojovenes";
$inventario=$objConexion->query($sql);
$msj='1,2';
?>


<form id="form1" name="form1" method="post" action="../Controlador/validarInsertarInventario5.php">
<head>
<meta charset="UTF-8">
<title>Insertar_Inventario_jovenes</title>
...
<br>
<br>
<h2>INGRESO DE NUEVOS ELEMENTOS A LA BODEGA JOVENES</h2>
