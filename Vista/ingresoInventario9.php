...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventariogeneral where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario9.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_general</title>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO GENERAL</h2>
