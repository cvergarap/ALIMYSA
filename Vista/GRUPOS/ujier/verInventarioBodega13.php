...
$sql="select * from inventarioujieres LIMIT 15";	  
$inventarioBodega = $objConexion->query($sql);
?><head>
<meta charset="utf-8">
<title>Ver_Inventario_Ujieres</title>
...
<br>
<br>
<h2>INVENTARIO ACTUAL EN BODEGA UJIERES</h2>
...
?>
	<tr>
		...
		<td>
			<a href="index2.php?pag=ingresoInventario2&idElemento=<?php echo $material->idElemento?>" title="SELECCIONAR">
