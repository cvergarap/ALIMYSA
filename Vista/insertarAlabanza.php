...
$sql="Insert nomMiembro,telMiembro,dirMiembro,correoMiembro from alabanza";
$alabanza=$objConexion->query($sql);
$msj='1,2';
?>


<form id="form1" name="form1" method="post" action="../Controlador/validarInsertarAlabanza.php" enctype="multipart/form-data">
<head>
<meta charset="UTF-8">
