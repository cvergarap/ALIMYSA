...
$sql="select * from inventariologistica LIMIT 15";	  
$inventarioBodega = $objConexion->query($sql);
?><head>
<meta charset="utf-8">
<title>Ver_Inventario_Logistico</title>
...
<br>
<br>
<h2>INVENTARIO ACTUAL EN BODEGA DE LOGISTICA GENERAL</h2>
...
?>
	<tr>
		...
		<td>
			<a href="index2.php?pag=ingresoInventario8&idElemento=<?php echo $material->idElemento?>" title="SELECCIONAR">
