...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventariodistri where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario10.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_final</title>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO FINAL DE CADA BODEGA</h2>

          <tbody>
          <tr>
            <h4> <td>NOMBRE DEL ELEMENTO A INCREMENTAR EN EL INVENTARIO FINAL DE LA BODEGA:</td></h4> 
