...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventariosamaritano where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario3.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_samaritano</title>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO DE LA BODEGA EL BUEN SAMARITANO</h2>
