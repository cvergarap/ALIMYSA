...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventariodamas where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario7.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_Damas</title>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO DAMAS</h2>
