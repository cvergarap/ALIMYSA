...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventarioujieres where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario2.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_ujieres</title>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO DE LA BODEGA UJIERES</h2>
