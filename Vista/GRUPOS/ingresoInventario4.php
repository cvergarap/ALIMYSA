...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventariojovenes where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario4.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_Jovenes</title>
...
<li> <a href="navegacion5.php"><h3>ATRAS</h3></a>
</li>
</ul>
</div>
</nav>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO DE LA BODEGA JOVENES</h2>
