...
//datos del producto
$sql="Insert nombElemento, cantElemento, mediElemento from inventarioinfantil";
$inventario=$objConexion->query($sql);
$msj='1,2';
?>


<form id="form1" name="form1" method="post" action="../Controlador/validarInsertarInventario4.php">
<head>
<meta charset="UTF-8">
<title>Insertar_Inventario_Infantil</title>
...
<br>
<br>
<h2>INGRESO DE NUEVOS ELEMENTOS A LA BODEGA INFANTIL</h2>
