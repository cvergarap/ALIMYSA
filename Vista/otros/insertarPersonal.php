...
//datos de personal
$sql="Insert idUsuario,userArea,userCodIdent,userNom,userApell,userTel,userCorreo,userPass from personal";
...
<h2>REGISTRO DE PERSONAL</h2>
          ...
          <tr>
			...
			<td><input name="correo" type="text" id="correo" size="53" required /></td>
						...
						<tr>
              <h4 <td>Contrase&ntilde;a:</td></h4> 
			<td><input name="pass" type="password" id="pass" size="53" required /></td>
            </tr>
          </tbody>
	</article>
