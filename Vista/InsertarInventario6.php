...
//datos del producto
$sql="Insert nombElemento, cantElemento, mediElemento from inventarioescbiblica";
$inventario=$objConexion->query($sql);
$msj='1,2';
?>


<form id="form1" name="form1" method="post" action="../Controlador/validarInsertarInventario3.php">
<head>
<meta charset="UTF-8">
<title>Insertar_Inventario_Escbiblica</title>
...
<br>
<br>
<h2>INGRESO DE NUEVOS ELEMENTOS A LA BODEGA ESCUELA BIBLICA</h2>
