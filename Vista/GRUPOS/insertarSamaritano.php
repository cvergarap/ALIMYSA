...
$sql="Insert nomMiembro,telMiembro,dirMiembro,correoMiembro from samaritano";
$samaritano=$objConexion->query($sql);
$msj='1,2';
?>


<form id="form1" name="form1" method="post" action="../Controlador/validarInsertarSamaritano.php" enctype="multipart/form-data">
<head>
<meta charset="UTF-8">
