...
if (isset($_REQUEST['idElemento']))
{
	...
	$sql="select * from inventarioescbiblica where idElemento = '$idElemento'";
...
<form id="form1" name="form1" method="post" action="../Controlador/validarSumarInventario6.php">
<head>
<meta charset="UTF-8">
<title>Sumar_Inventario_Escbiblica</title>
...
<li> <a href="navegacion3.php"><h3>ATRAS</h3></a>
</li>
</ul>
</div>
</nav>
...
<br>
<br>
<h2>ADICION DE STOCK AL INVENTARIO ESCUELA BIBLICA</h2>
